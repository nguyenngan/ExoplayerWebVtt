...
//      }
          DataSource textDataSource = new DefaultUriDataSource(context, bandwidthMeter, userAgent);
          MediaFormat mediaFormat = MediaFormat.createTextFormat("de", MimeTypes.TEXT_VTT, MediaFormat.NO_VALUE, C.MATCH_LONGEST_US, "deutsch");
          String THE_WEBVTT_URL = "http://www.daserste.de/api/unterhaltung/quiz-show/gefragt-gejagt/videos/promi-special-mit-desir-e-nick-timo-dierkes-heike-henkel-und-thorsten-schroeder-ut102~_type-webvtt.vtt";
          textRenderer = new TextTrackRenderer(new SingleSampleSource(Uri.parse(THE_WEBVTT_URL), textDataSource, mediaFormat), player, mainHandler.getLooper());
      }
